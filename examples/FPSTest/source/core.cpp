...
// Igual ao GetFirstBodyCollided acima, mas tambem devolve o ponto e a normal
// REAIS de impacto (rayCallback.m_hitPointWorld / m_hitNormalWorld) em vez de
// somente o corpo atingido. O chamador NAO deve usar hitBody->getWorldTransform()
// para achar "onde bateu": isso retorna o centro de massa do corpo, nao a
// superficie. outHitPoint / outHitNormal so sao validos quando o retorno != nullptr.
