...
- Paste .dll files from redist/<your cpu architecture> into the release or debug folder of your project, or exacly where the output executable is located.
- Paste .lib files from redist/<your cpu architecture> into the source code folder. If necessary, open FiscionCore.h and alter the directory of these .lib files since the solution directory.
